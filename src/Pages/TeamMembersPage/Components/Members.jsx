...
const Members = () => {
  ...
  return (
    <div className="relative mx-auto py-10 w-full max-w-7xl bg-gray-50 text-gray-700 rounded-md">

      {/* :TITLE CONTAINER */}
      <div className="mb-8 flex justify-center items-center">
        <span className="h-1 w-14 rounded-3xl bg-gray-700" />
        <h2 className="px-3 text-sm font-semibold uppercase">TEAM MEMBERS</h2>
        <span className="h-1 w-14 rounded-3xl bg-gray-700" />
      </div>
